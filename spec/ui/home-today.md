...
- 空态和已有记录状态都保持 `2 × 2` 网格，保证早餐、午餐、晚餐、夜宵四个入口在常见手机首屏内同时可见，餐次顺序不变。
- 四宫格应占用日期、回顾卡和底部导航之间的剩余首屏高度；卡片随设备高度弹性伸展，避免为了首屏展示而过度压缩，也不在第二排下方留下大块无意义空白。
- 已记录卡使用紧凑图片信息卡呈现餐食照片、餐次名称和处理结果；更多操作位于右上角，整卡仍可进入详情。
